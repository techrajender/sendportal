<ul class="nav nav-pills mb-3">
    ...
    <li class="nav-item">
        <a class="nav-link {{ request()->route()->named('sendportal.campaigns.reports.tracking') ? 'active'  : '' }}"
           href="{{ route('sendportal.campaigns.reports.tracking', $campaign->id) }}">{{ __('Tracking') }}</a>
    </li>
</ul>
